...
namespace CloudFabric.BuisnessRules.Tests
{
    ...
    {
        private static Comparer _comparer = new Comparer(ComparerTypeEnum.NumberComparer, (int)NumberComparerTypeEnum.GreaterThan);
        ...
        [Fact]
        public void TwoIsNotGreaterThanTwo()
        {
