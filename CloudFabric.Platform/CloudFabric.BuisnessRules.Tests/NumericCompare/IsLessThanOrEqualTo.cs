...
namespace CloudFabric.BuisnessRules.Tests
{
    ...
    {
        private static Comparer _comparer = new Comparer(ComparerTypeEnum.NumberComparer, (int)NumberComparerTypeEnum.LessThanOrEqual);
        ...
        [Fact]
        public void OneIsLessThanOrEqualtoTwo()
        {
        ...
        [Fact]
        public void TwoIsNotLessThanOrEqualToOne()
        {
        ...
        [Fact]
        public void TwoIsLessThanOrEqualToTwo()
        {
